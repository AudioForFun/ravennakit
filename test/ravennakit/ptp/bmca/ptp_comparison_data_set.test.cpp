...
TEST_CASE("ptp_comparison_data_set") {
    ...
    SECTION("Grandmaster identity is equal") {
        SECTION("Steps removed of a is better") {
            a.steps_removed -= 2;
            REQUIRE(a.compare(b) == rav::ptp_comparison_data_set::ordering::better);
        }
        SECTION("Steps removed of a is worse") {
            a.steps_removed += 2;
            REQUIRE(a.compare(b) == rav::ptp_comparison_data_set::ordering::worse);
        }
        ...
        SECTION("Steps removed of a is better") {
            ...
            SECTION("Receiver > Sender") {
                ...
                REQUIRE(a.compare(b) == rav::ptp_comparison_data_set::ordering::better_by_topology);
            }
        }
        ...
        SECTION("Steps removed of a is worse") {
            ...
            SECTION("Receiver > Sender") {
                ...
                REQUIRE(a.compare(b) == rav::ptp_comparison_data_set::ordering::worse_by_topology);
            }
        }
    ...
    SECTION("Order of ordering") {
        using ordering = rav::ptp_comparison_data_set::ordering;
